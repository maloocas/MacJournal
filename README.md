...
### 🎯 Daily Goals
Set and track up to 5 daily goals with checkable progress:

- **Daily tracking** — create up to 5 goals per day, each independently checkable
- **Date-bound** — goals are tied to specific dates for easy daily planning
- **Persistent storage** — synced with your journal data
- **Seamless workflow** — manage goals alongside your daily log entries
